...
namespace CSharpSeleniumExtentReportNetCoreTemplate.Bases
{
    public class PageBase
    {
        ...
        protected WebDriverWait wait { get; private set; } //ciando um atributo de espera
        protected IWebDriver driver { get; private set; } //selenium trabalha  
        protected IJavaScriptExecutor javaScript { get; private set; } 

        public PageBase()
        {
            wait = new WebDriverWait(DriverFactory.INSTANCE, TimeSpan.FromSeconds(Convert.ToInt32(BuilderJson.ReturnParameterAppSettings("DEFAULT_TIMEOUT_IN_SECONDS"))));
